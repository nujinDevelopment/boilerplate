...
<template>
  <div class="dropdown-end dropdown z-10">
    ...
    <ul
      ...
      <li>
        <label class="swap swap-rotate block w-full">
          <input 
            type="checkbox" 
            @change="setTheme(theme === 'light' ? 'dark' : theme === 'dark' ? 'system' : 'light')" 
          />
          ...
          <svg
            class="swap-off h-5 w-5 fill-current"
            :class="{ 'hidden': theme !== 'system' }"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24">
            <path d="M2 4a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V4zm2 0v16h16V4H4zm8 3a1 1 0 0 1 1 1v8a1 1 0 1 1-2 0V8a1 1 0 0 1 1-1z"/>
          </svg>
        </label>
      </li>
